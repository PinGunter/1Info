...
LDLIBSOPTIONS=../local/lib/liblanguage.a ../local/lib/libwordlist.a ../local/lib/libansiterminal.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tests

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tests: ../local/lib/liblanguage.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tests: ../local/lib/libwordlist.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tests: ../local/lib/libansiterminal.a
...
${OBJECTDIR}/src/window.o: src/window.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I../local/include -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/window.o src/window.cpp
