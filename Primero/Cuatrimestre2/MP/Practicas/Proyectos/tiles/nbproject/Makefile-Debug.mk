...
LDLIBSOPTIONS=../local/lib/liblanguage.a ../local/lib/libwordlist.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tiles

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tiles: ../local/lib/liblanguage.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tiles: ../local/lib/libwordlist.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tiles: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tiles ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/src/movelist.o: src/movelist.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I../local/include -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/movelist.o src/movelist.cpp
...
${OBJECTDIR}/src/tiles.o: src/tiles.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I../local/include -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tiles.o src/tiles.cpp
