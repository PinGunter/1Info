...
int main(){
   ...
   do{
      ...
      if (entrada == '#')
         contador_hash += 1;                 //Queremos que cuente los # que hay en la secuencia, como el codigo se encuentra entre #
                                             //los computos los haremos cuando el contador sea mayor 1
      if (contador_hash >= 1){
