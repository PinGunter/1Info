...
int main (){
   ...
   cout << "\tApartado A\nIntroduce el dia, mes y anio (separados por espacios):\n";
   ...
   bool mes31 = (mes%2==1 && mes != 11) || mes==8 || mes == 12;                               //Si es true el mes tiene 31 dias
   ...
   cout << "\tApartado B\nUn dia siguiente al introducido es: " << dia << barra << mes << barra << anio << endl;
   

   // ----- Actualizar la fecha al dia anterior ----- //
   //Volvemos a establecer las variables a su valor anterior para que no haya problemas de calculo
   ...
   cout << "\tApartado C\nUn dia anterior al introducido es " << dia << barra << mes << barra << anio << endl;

   //Apartado D

   cout << "\tApartado D\nfecha_var es una copia de fecha_us.\n";
   cout << "fecha_us: " << fecha_us.dia << barra << fecha_us.mes << barra << fecha_us.anio << endl;
   cout << "fecha_var: " << fecha_var.dia << barra << fecha_var.mes << barra << fecha_var.anio << endl;

   //Apartado E
   //Esto ya lo habiamos comprobado con la variable "es_bisiesto" 
